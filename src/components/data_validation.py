...
Steps:
    ...
    Validates column count for both
    Validates presence of categorical & numerical columns
    Logs validation status in a structured report (JSON)
    Returns DataValidationArtifact containing:
